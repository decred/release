...
require (
	...
	decred.org/dcrdex-assets v0.4.3
)

require (
	decred.org/dcrwallet/v2 v2.0.0-20211206163037-9537363becbb // indirect
	...
	github.com/jessevdk/go-flags v1.4.1-0.20200711081900-c17162fe8fd7 // indirect
